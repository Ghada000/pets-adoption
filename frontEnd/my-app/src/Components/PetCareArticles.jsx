...
const PetCareArticles = () => {
  ...
  return (
    <>
      <h1>All you need to know about your new pet</h1>
      <div className="pet-care-articles">
        ...
        <article className="pet-article">
          {/* ... (your existing content) */}
          <img src="https://plus.unsplash.com/premium_photo-1673515785730-67054ee2962c?q=80&w=1854&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Pet 3" />
          <div className="article-content">
